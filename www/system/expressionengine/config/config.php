...
$config['app_version'] = '200pb01';
$config['install_lock'] = "";
$config['license_number'] = '5112-6252-1182-3614';
$config['debug'] = '1';
$config['cp_url'] = 'http://ee.local.net:8080/system/index.php';
$config['doc_url'] = 'http://expressionengine.com/public_beta/docs/';
$config['is_system_on'] = 'y';
$config['site_label'] = 'Chris Hardcastle';
