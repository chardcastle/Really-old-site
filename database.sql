...
CREATE TABLE `kh_posts` (
  ...
  PRIMARY KEY  (`post_id`)
) ENGINE=MyISAM AUTO_INCREMENT=411 DEFAULT CHARSET=latin1 COMMENT='Stores all posts as json';
SET character_set_client = @saved_cs_client;
...
INSERT INTO `kh_posts` VALUES (341,'jQuery','Mobile WebKit browsers don\'t support accessing the scroll position of the document/window.',1269610058,1269552613,'gitcommit'),(342,'jQuery','Need to expose the isLocal change globally as well.',1269610058,1269461773,'gitcommit'),(343,'jQuery','Temporarily disable ajax tests when running in TestSwam.',1269610058,1269461050,'gitcommit'),(344,'jQuery','Use custom events for testing unbind instead of the, potentially conflicting, error event.',1269610058,1269459598,'gitcommit'),(345,'jQuery','Adjust isPlainObject test to run in an iframe.',1269610058,1269458291,'gitcommit'),(346,'jQuery','Make sure the offset tests work without a built jQuery file.',1269610058,1269376660,'gitcommit'),(347,'jQuery','Update other remote test URLs as well.',1269610058,1269375891,'gitcommit'),(348,'jQuery','Strip off filename and query string for JSONP Remote test.',1269610058,1269375729,'gitcommit'),(349,'jQuery','Update the TestSwarm URL to point to the new jQuery swarm location.',1269610058,1269372102,'gitcommit'),(350,'jQuery','Changed the order of the tests to run in the same order in which they\'re specified in the Makefile (fixed a dimensions test bug that popped up as a result).',1269610058,1269361900,'gitcommit'),(351,'jQuery','Handle auto-running of the TestSwarm injection script in the test suite.',1269610058,1269361187,'gitcommit'),(352,'jQuery','Made it so that you no longer need to build jQuery in order to run the test suite (but you\'ll still need a checkout of QUnit and Sizzle, at least).',1269610058,1269360736,'gitcommit'),(353,'jQuery','Switch to using String.prototype.trim from String.trim as it\'s more-widely available.',1269610058,1268322559,'gitcommit'),(354,'jQuery','Rewrote the live/delegate submit tests to be more generic.',1269610058,1268161713,'gitcommit'),(355,'jQuery','Make sure that special remove and teardown events get called when .die() is used. Additionally made sure that default actions are triggered when namespaced events are used. Fixes #6202 and #6250.',1269610058,1268155345,'gitcommit'),(356,'jQuery','Removing the mention of buliding the docs from the README. Thanks to \'phihag\' in the forum for the heads-up.',1269610058,1268144195,'gitcommit'),(357,'jQuery','Landing a faster trim method. Based upon the work by Travis Hardiman and DBJDBJ. More details here: http://forum.jquery.com/topic/faster-jquery-trim Fixes #2279, #4452, and #4835.',1269610058,1268144067,'gitcommit'),(358,'jQuery','No need to use .call() anymore since we switched from .apply() for appendTo, etc. Thanks to Robert in 2c08004f6d4e7f11a875190e132d204a25cb9418 for the heads-up.',1269610058,1267801198,'gitcommit'),(359,'jQuery','I take that back! It was a bug, but the cache had to be triggered and a collection of cached nodes had to be passed in (an odd case to be sure). Fixes #6227.',1269610058,1267766087,'gitcommit'),(360,'jQuery','Attempted to fix #6227, not entirely sure if it\'s a problem as I\'m having a hard time reproducing it. Regardless, the change is harmless and potentially even speeds up appendTo, etc. slightly.',1269610058,1267765677,'gitcommit'),(361,'jQuery','Added in Ben Alman\'s proposed event.namespace property (the property holds the namespaces specified in a call to trigger). Additionally fixes namespaces with .live(). Fixes #6208 and #6209.',1269610058,1267569252,'gitcommit'),(362,'jQuery','Make sure that we don\'t try to remove data from an applet. Re-Fixes #1675.',1269610058,1267556175,'gitcommit'),(363,'jQuery','Add in the new level information to the closest(Array) test.',1269610058,1267545234,'gitcommit'),(364,'jQuery','We no longer support globally-triggered events on plain objects. This is a trade-off to having good garbage collection on the objects.',1269610058,1267545091,'gitcommit'),(365,'jQuery','Moving more properties onto jQuery.ajax, also copy them back to the jQuery object for backwards compatibility.',1269610058,1267544688,'gitcommit'),(366,'jQuery','Remove the need for the return in sizzle-jquery and just remove the attempt to expose Sizzle completely. jQuery is 100% passing JSLint (\'make lint\') now.',1269610058,1267498568,'gitcommit'),(367,'jQuery','Added in integrated JSLint checking against the jQuery source. Just run \'make lint\' to see the result.',1269610058,1267498304,'gitcommit'),(368,'jQuery','More changes to get jQuery in line with JSLint.',1269610058,1267496689,'gitcommit'),(369,'jQuery','We don\'t want to increment the Ajax counter if there isn\'t a global event.',1269610058,1267489873,'gitcommit'),(370,'jQuery','Land some additional tweaks related to running through JSLint.',1269610058,1267485569,'gitcommit'),(371,'tweet','hardcastle: &lt;bugs&gt;GITHub cost me a bank fine. USB Stick won\'t format. My space bar has fallen out.&lt;/bugs&gt; --&gt; what next?',1269610058,1269551491,'tweet'),(372,'tweet','hardcastle: Install the magnatune iPhone app For #free #music, like spotify (smaller library)',1269610058,1269547128,'tweet'),(373,'tweet','hardcastle: “All programmers are playwrights and all computers are lousy actors.” - unkown',1269610058,1269479533,'tweet'),(374,'tweet','hardcastle: @andygirvan RE jQ-ui 1.8 my fav features are \"explode\" and backgroundColor animate',1269610058,1269431405,'tweet'),(375,'tweet','hardcastle: @jevillustration queens more like... Where\'s the cheezburger at?',1269610058,1269202801,'tweet'),(376,'tweet','hardcastle: I\'m having fun with the tumblr iTouch app, but the navigation is a little poor IMHO',1269610058,1269168667,'tweet'),(377,'tweet','hardcastle: What kind of a programmer are you? http://bit.ly/5sJSZ0',1269610058,1269123166,'tweet'),(378,'tweet','hardcastle: Just been handed a new project titled \"Project freedom!\"',1269610058,1269001876,'tweet'),(379,'tweet','hardcastle: @spol wu-ho Every thing I know about .NET is off stackoverflow. I\'m sure that will help :)',1269610058,1268920000,'tweet'),(380,'tweet','hardcastle: Requesting object JSON from LINQ via AJAX, it\'s very fast, fun and so easy! For now.',1269610058,1268911779,'tweet'),(381,'tweet','hardcastle: \"If you make it idiot proof, they\'ll build a better idiot\" - unknown',1269610058,1268821938,'tweet'),(382,'tweet','hardcastle: Just sending @andygirvan a GIT bundle as documented here http://bit.ly/bN2gWp I love to share code!',1269610058,1268776633,'tweet'),(383,'tweet','hardcastle: Our kid\'s got a blocked nose. He\'s asleep in his cot and sounds like baby Darth Vader. #awww',1269610058,1268773463,'tweet'),(384,'tweet','hardcastle: RT @trs21219: @philsturgeon git clone jessica alba; git checkout -b ass; --&gt; git archive kelly brooke',1269610058,1268771686,'tweet'),(385,'tweet','hardcastle: @calypsomustdie as a contestant or galidiator?',1269610058,1268512954,'tweet'),(386,'tweet','hardcastle: We\'ve just been watching 3D TV here in the office. It\'s spectacular!',1269610058,1268327770,'tweet'),(387,'tweet','hardcastle: I had my photo taken in THE Burberry photo studio today for an unknown reason. Fun and random.',1269610058,1268262150,'tweet'),(388,'tweet','hardcastle: Had my photo taken in the Burberry Photo studio, still not sure why',1269610058,1268234230,'tweet'),(389,'tweet','hardcastle: @whathomasthinks what a clever teddy ;)',1269610058,1268164338,'tweet'),(390,'tweet','hardcastle: @CathrynCook yes, it takes place of honour in our house! The weekend photos look fantastic :)',1269610058,1268164267,'tweet'),(391,'tumblr','<p><bugs>GITHub cost me a bank fine. USB Stick won’t format. My space bar has fallen out.</bugs> —> what next?</p>',1269610058,1269555399,'tumblr'),(392,'tumblr','<p>Install the magnatune iPhone app For #free #music, like spotify (smaller library)</p>',1269610058,1269549350,'tumblr'),(393,'tumblr','<p>“All programmers are playwrights and all computers are lousy actors.” - unkown</p>',1269610058,1269483610,'tumblr'),(394,'tumblr','<img src=\"http://26.media.tumblr.com/tumblr_kznm2uEavc1qzpuawo1_400.png\"/><br/><br/>',1269610058,1269211781,'tumblr'),(395,'tumblr','<img src=\"http://30.media.tumblr.com/tumblr_kz15zqGEkr1qzpuawo1_500.jpg\"/><br/><br/><p>I’ve never felt so proud of our family name than to discover that such a TV was ever conceived. Absolute win with Hardcastle plastered all over it.</p>',1269610058,1268164502,'tumblr'),(396,'tumblr','<p>I dipped my toe in the jQuery water today by writing custom extensions. Now I want to go swimming!</p>',1269610058,1244899036,'tumblr'),(397,'tumblr','<p><a href=\"http://twitpic.com/73uj6\">http://twitpic.com/73uj6</a> - Ian with Luke on a recent visit to London</p>',1269610058,1244726061,'tumblr'),(398,'tumblr','<p>Super chirp <a href=\"http://bit.ly/iQM8U\">http://bit.ly/iQM8U</a> premium twitter service. I wonder if it’s a game changer..</p>',1269610058,1244639661,'tumblr'),(399,'tumblr','<p>#geekpickuplines I wish we could auto increment our datetime()</p>',1269610058,1244639660,'tumblr'),(400,'tumblr','<p>Code igniter can query for and export database records in 3 lines of code!</p>',1269610058,1244553049,'tumblr'),(401,'tumblr','<p>#robotpickuplines hey baby, I cannot clear you from my session cache, do you want to swap network addresses?</p>',1269610058,1244293845,'tumblr'),(402,'tumblr','<p>RT @yorasband: #lastfm #love Retreat! Retreat! by 65daysofstatic <a href=\"http://bit.ly/IN5D1\">http://bit.ly/IN5D1</a></p>',1269610058,1244120773,'tumblr'),(403,'tumblr','<p>RT @yorasband: Full length video of (Rearranging) Deckchairs recorded live at The Good Ship - <a href=\"http://bit.ly/Bgrxq\">http://bit.ly/Bgrxq</a> If you like it please RT!</p>',1269610058,1244120773,'tumblr'),(404,'tumblr','<p>RT comment: Facebook on the XBOX “As if facebook wasn’t slow and glitchy enough this will kill it!”</p>',1269610058,1244034369,'tumblr'),(405,'tumblr','<p>Apparently nom means “to drink” in Japanese #nom</p>',1269610058,1243947967,'tumblr'),(406,'tumblr','<p>PVI to buy E Ink (and patents) for (only) $215 million - engadget</p>',1269610058,1243861568,'tumblr'),(407,'tumblr','<p><a href=\"http://bit.ly/ashnS\">http://bit.ly/ashnS</a> - HD video cam for under £150?!</p>',1269610058,1243861567,'tumblr'),(408,'tumblr','<p>Iz having east african cusine sw8</p>',1269610058,1243688766,'tumblr'),(409,'tumblr','<p>today I will be happier than a bird with a french fry.</p>',1269610058,1243602356,'tumblr'),(410,'tumblr','<p><a href=\"http://twitpic.com/66dvk\">http://twitpic.com/66dvk</a> - This is my new conky desktop configuration. I am thinking of adding a summary of twitter information using a …</p>',1269610058,1243602356,'tumblr');
...
-- Dump completed on 2010-03-26 13:29:56
