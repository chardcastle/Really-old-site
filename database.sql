...
CREATE TABLE `kh_posts` (
  ...
  `teaser` text,
  PRIMARY KEY  (`post_id`)
) ENGINE=MyISAM AUTO_INCREMENT=517 DEFAULT CHARSET=latin1 COMMENT='Stores all posts as json';
SET character_set_client = @saved_cs_client;
...
INSERT INTO `kh_posts` VALUES (449,'jQuery','Mobile WebKit browsers don\'t support accessing the scroll position of the document/window.',1269858674,1269552613,'gitcommit',NULL),(450,'jQuery','Need to expose the isLocal change globally as well.',1269858674,1269461773,'gitcommit',NULL),(451,'jQuery','Temporarily disable ajax tests when running in TestSwam.',1269858674,1269461050,'gitcommit',NULL),(452,'jQuery','Use custom events for testing unbind instead of the, potentially conflicting, error event.',1269858674,1269459598,'gitcommit',NULL),(453,'jQuery','Adjust isPlainObject test to run in an iframe.',1269858674,1269458291,'gitcommit',NULL),(454,'jQuery','Make sure the offset tests work without a built jQuery file.',1269858674,1269376660,'gitcommit',NULL),(455,'jQuery','Update other remote test URLs as well.',1269858674,1269375891,'gitcommit',NULL),(456,'jQuery','Strip off filename and query string for JSONP Remote test.',1269858674,1269375729,'gitcommit',NULL),(457,'jQuery','Update the TestSwarm URL to point to the new jQuery swarm location.',1269858674,1269372102,'gitcommit',NULL),(458,'jQuery','Changed the order of the tests to run in the same order in which they\'re specified in the Makefile (fixed a dimensions test bug that popped up as a result).',1269858674,1269361900,'gitcommit',NULL),(459,'jQuery','Handle auto-running of the TestSwarm injection script in the test suite.',1269858674,1269361187,'gitcommit',NULL),(460,'jQuery','Made it so that you no longer need to build jQuery in order to run the test suite (but you\'ll still need a checkout of QUnit and Sizzle, at least).',1269858674,1269360736,'gitcommit',NULL),(461,'jQuery','Switch to using String.prototype.trim from String.trim as it\'s more-widely available.',1269858674,1268322559,'gitcommit',NULL),(462,'jQuery','Rewrote the live/delegate submit tests to be more generic.',1269858674,1268161713,'gitcommit',NULL),(463,'jQuery','Make sure that special remove and teardown events get called when .die() is used. Additionally made sure that default actions are triggered when namespaced events are used. Fixes #6202 and #6250.',1269858674,1268155345,'gitcommit',NULL),(464,'jQuery','Removing the mention of buliding the docs from the README. Thanks to \'phihag\' in the forum for the heads-up.',1269858674,1268144195,'gitcommit',NULL),(465,'jQuery','Landing a faster trim method. Based upon the work by Travis Hardiman and DBJDBJ. More details here: http://forum.jquery.com/topic/faster-jquery-trim Fixes #2279, #4452, and #4835.',1269858674,1268144067,'gitcommit',NULL),(466,'jQuery','No need to use .call() anymore since we switched from .apply() for appendTo, etc. Thanks to Robert in 2c08004f6d4e7f11a875190e132d204a25cb9418 for the heads-up.',1269858674,1267801198,'gitcommit',NULL),(467,'jQuery','I take that back! It was a bug, but the cache had to be triggered and a collection of cached nodes had to be passed in (an odd case to be sure). Fixes #6227.',1269858674,1267766087,'gitcommit',NULL),(468,'jQuery','Attempted to fix #6227, not entirely sure if it\'s a problem as I\'m having a hard time reproducing it. Regardless, the change is harmless and potentially even speeds up appendTo, etc. slightly.',1269858674,1267765677,'gitcommit',NULL),(469,'jQuery','Added in Ben Alman\'s proposed event.namespace property (the property holds the namespaces specified in a call to trigger). Additionally fixes namespaces with .live(). Fixes #6208 and #6209.',1269858674,1267569252,'gitcommit',NULL),(470,'jQuery','Make sure that we don\'t try to remove data from an applet. Re-Fixes #1675.',1269858674,1267556175,'gitcommit',NULL),(471,'jQuery','Add in the new level information to the closest(Array) test.',1269858674,1267545234,'gitcommit',NULL),(472,'jQuery','We no longer support globally-triggered events on plain objects. This is a trade-off to having good garbage collection on the objects.',1269858674,1267545091,'gitcommit',NULL),(473,'jQuery','Moving more properties onto jQuery.ajax, also copy them back to the jQuery object for backwards compatibility.',1269858674,1267544688,'gitcommit',NULL),(474,'jQuery','Remove the need for the return in sizzle-jquery and just remove the attempt to expose Sizzle completely. jQuery is 100% passing JSLint (\'make lint\') now.',1269858674,1267498568,'gitcommit',NULL),(475,'jQuery','Added in integrated JSLint checking against the jQuery source. Just run \'make lint\' to see the result.',1269858674,1267498304,'gitcommit',NULL),(476,'jQuery','More changes to get jQuery in line with JSLint.',1269858674,1267496689,'gitcommit',NULL),(477,'jQuery','We don\'t want to increment the Ajax counter if there isn\'t a global event.',1269858674,1267489873,'gitcommit',NULL),(478,'jQuery','Land some additional tweaks related to running through JSLint.',1269858674,1267485569,'gitcommit',NULL),(479,'tweet','hardcastle: It\'s 4am and our house it littered with patches of baby puke #eeeew #WorseThanPoop',1269858674,1269746426,'tweet',NULL),(480,'tweet','hardcastle: @glynroberts #jailbreak sounds great, shame I\'m too late :( was at dads group with luke :)',1269858674,1269704966,'tweet',NULL),(481,'tweet','hardcastle: @glynroberts look at pixelotto which I think was grown from little funding into a success',1269858674,1269704704,'tweet',NULL),(482,'tweet','hardcastle: loving the #spooktreasurehunt',1269858674,1269621456,'tweet',NULL),(483,'tweet','hardcastle: @calypsomustdie no-way, that\'s awsum! It must be #tfif #spookhunt GAME ON!',1269858674,1269617906,'tweet',NULL),(484,'tweet','hardcastle: &lt;bugs&gt;GITHub cost me a bank fine. USB Stick won\'t format. My space bar has fallen out.&lt;/bugs&gt; --&gt; what next?',1269858674,1269551491,'tweet',NULL),(485,'tweet','hardcastle: Install the magnatune iPhone app For #free #music, like spotify (smaller library)',1269858674,1269547128,'tweet',NULL),(486,'tweet','hardcastle: “All programmers are playwrights and all computers are lousy actors.” - unkown',1269858674,1269479533,'tweet',NULL),(487,'tweet','hardcastle: @andygirvan RE jQ-ui 1.8 my fav features are \"explode\" and backgroundColor animate',1269858674,1269431405,'tweet',NULL),(488,'tweet','hardcastle: @jevillustration queens more like... Where\'s the cheezburger at?',1269858674,1269202801,'tweet',NULL),(489,'tweet','hardcastle: I\'m having fun with the tumblr iTouch app, but the navigation is a little poor IMHO',1269858674,1269168667,'tweet',NULL),(490,'tweet','hardcastle: What kind of a programmer are you? http://bit.ly/5sJSZ0',1269858674,1269123166,'tweet',NULL),(491,'tweet','hardcastle: Just been handed a new project titled \"Project freedom!\"',1269858674,1269001876,'tweet',NULL),(492,'tweet','hardcastle: @spol wu-ho Every thing I know about .NET is off stackoverflow. I\'m sure that will help :)',1269858674,1268920000,'tweet',NULL),(493,'tweet','hardcastle: Requesting object JSON from LINQ via AJAX, it\'s very fast, fun and so easy! For now.',1269858674,1268911779,'tweet',NULL),(494,'tweet','hardcastle: \"If you make it idiot proof, they\'ll build a better idiot\" - unknown',1269858674,1268821938,'tweet',NULL),(495,'tweet','hardcastle: Just sending @andygirvan a GIT bundle as documented here http://bit.ly/bN2gWp I love to share code!',1269858674,1268776633,'tweet',NULL),(496,'tweet','hardcastle: Our kid\'s got a blocked nose. He\'s asleep in his cot and sounds like baby Darth Vader. #awww',1269858674,1268773463,'tweet',NULL),(497,'tweet','hardcastle: RT @trs21219: @philsturgeon git clone jessica alba; git checkout -b ass; --&gt; git archive kelly brooke',1269858674,1268771686,'tweet',NULL),(498,'tweet','hardcastle: @calypsomustdie as a contestant or galidiator?',1269858674,1268512954,'tweet',NULL),(499,'tumblr','<p><a href=\"http://fuckyeahcomputerscience.tumblr.com/post/304069328/xd\">fuckyeahcomputerscience</a>:</p>\n<blockquote>\n<p><a href=\"http://ayiie.tumblr.com/post/304048865/xd\">ayiie</a>:</p>\n<blockquote>\n<p>Dear Tech Support:<br/>Last year I upgraded from Girlfriend 7.0 to Wife 1.0. I soon noticed that the new program began unexpected child processing that took up a lot of space and resources. In addition, Wife 1.0 installed itself into all other programs and now monitors all other system activity. Applications such as Poker Night 10.3, Football 5.0, HuntingAndFishing 7.5, and Racing 3.6. I can’t seem to keep Wife 1.0 in the background while attempting to run my favorite applications. I’m thinking about going back to Girlfriend 7.0, but the uninstall doesn’t work on Wife 1.0. Please help!<!-- more --><br/><br/>Thanks …Troubled User<br/>———-<br/>REPLY:<br/><br/>Dear Troubled User:<br/>This is a very common problem. Many people upgrade from Girlfriend 7.0 to Wife 1.0, thinking that it is just a Utilities and Entertainment program. Wife 1.0 is an OPERATING SYSTEM and is designed by its Creator to run EVERYTHING!!! It is also impossible to delete Wife 1.0 and to return to Girlfriend 7.0. It is impossible to uninstall, or purge the program files from the system once installed. You cannot go back to Girlfriend 7.0 because Wife 1.0 is designed not to allow this. Look in your Wife 1.0 manual under Warnings-Alimony-Child Support. I recommend that you keep Wife 1.0 installed and work on improving the configuration. I suggest installing the background application YesDear 99.0 to alleviate software augmentation.<br/><br/>The best course of action is to enter the command C:APOLOGIZE because ultimately you will have to do this before the system will return to normal anyway.<br/><br/>Wife 1.0 is a great program, but it tends to be very high maintenance. Wife 1.0 comes with several support programs, such as CleanAndSweep 3.0, CookIt 1.5 and DoBills 4.2. However, be very careful how you use these programs. Improper use will cause the system to launch the program NagNag 9.5. Once this happens, the only way to improve the performance of Wife 1.0 is to purchase additional software. I recommend Flowers 2.1 and Diamonds 5.0, but beware because sometimes these applications can be expensive.<br/><br/>WARNING!!! DO NOT, under any circumstances, install SecretaryWithShortSkirt 3.3. This application is not supported by Wife 1.0 and will cause irreversible damage to the operating system.</p>\n<p>WARNING!!! Attempting to install NewGirlFriend 8.8 along with Wife 1.0 will crash the system.<br/><br/>(see Wife 1.0 manual, Apologize, High Maintenance & Secretary with Short Skirt)</p>\n<p>=)) Gets nyo xD</p>\n</blockquote>\n</blockquote>',1269858674,1269613980,'tumblr','{$teaser}'),(500,'tumblr','<img src=\"http://26.media.tumblr.com/tumblr_kznm2uEavc1qzpuawo1_400.png\"/><br/><br/>',1269858674,1269211781,'tumblr',NULL),(501,'tumblr','<img src=\"http://30.media.tumblr.com/tumblr_kz15zqGEkr1qzpuawo1_500.jpg\"/><br/><br/><p>I’ve never felt so proud of our family name than to discover that such a TV was ever conceived. Absolute win with Hardcastle plastered all over it.</p>',1269858674,1268164502,'tumblr',NULL),(502,'tumblr','<img src=\"http://28.media.tumblr.com/oFlImAcRLf9oyod5XgRCAkP9o1_500.jpg\"/><br/><br/><p>This is Ruth performing at the famous 100 club in Oxford street. It was a great night.</p>',1269858674,1224449059,'tumblr',NULL),(503,'tumblr','<p>Why I am being bitten my mosquitoes in the middle of rocktober?</p>',1269858674,1223819057,'tumblr',NULL),(504,'tumblr','<a href=\"http://guerillaradio.net/\">Yes you can haz music</a>',1269858674,1222807607,'tumblr',NULL),(505,'tumblr','<object width=\"400\" height=\"336\"><param name=\"movie\" value=\"http://www.youtube.com/v/q8Z--jWWFVw&rel=0&egm=0&showinfo=0&fs=1\"></param><param name=\"wmode\" value=\"transparent\"></param><param name=\"allowFullScreen\" value=\"true\"></param><embed src=\"http://www.youtube.com/v/q8Z--jWWFVw&rel=0&egm=0&showinfo=0&fs=1\" type=\"application/x-shockwave-flash\" width=\"400\" height=\"336\" allowFullScreen=\"true\" wmode=\"transparent\"></embed></object><br/><br/><p>A touch of genius for those who love bass guitar. What a tune, perfect for walking down the street on a sunny day.</p>',1269858674,1222806996,'tumblr',NULL),(506,'tumblr','<blockquote>\n<p>“Requiring employees to type ‘WWW’ cost companies over $25 billion last year,” said ICANN representative Emil Scharnsdorf. “The average Internet surfer takes two seconds to type ‘www’ and visits 125 sites a day, add in typos like “qqq” and “ww,” then wave your hands over your head three times and you’re at $25 billion.”</p>\n<p>“We’re only concerned with the Internet, but it takes Mandy Patinkin three seconds to say ‘www’ and during the Super Bowl that gets expensive.”</p>\n<p><a title=\"Source\" href=\"http://codeclimber.net.nz/archive/2007/09/28/To-www-or-not-to-www.aspx\">source</a></p>\n\n\n</blockquote>',1269858674,1220201356,'tumblr',NULL),(507,'tumblr','<p>I mentioned something I quite often use during a conversation about the internet. The Romans built roads, the Victorians built railways and we. Today build the information super highway [yuk - (i mean the web)] - just thought I would share that.</p>',1269858674,1220053743,'tumblr',NULL),(508,'tumblr','<img src=\"http://26.media.tumblr.com/oFlImAcRLd6usj9iFb5AmxjX_500.jpg\"/><br/><br/><p>Frank and Annie performed last night at the old nun’s head. Nunhead, Lodon. They were fantastic!</p>',1269858674,1219923887,'tumblr',NULL),(509,'tumblr','<img src=\"http://28.media.tumblr.com/oFlImAcRLd6ujr313aLnfQPL_500.jpg\"/><br/><br/><p>Last night, I thought ruth looked like a hindu goodess. Now that I am sober, it’s a terrible picture of my gorgeous wife.</p>',1269858674,1219923477,'tumblr',NULL),(510,'tumblr','<img src=\"http://26.media.tumblr.com/oFlImAcRLd5pq9hxjb2GYcQT_500.jpg\"/><br/><br/><p>The latest scan @ 12 weeks! Baby installation nearly complete.</p>',1269858674,1219854916,'tumblr',NULL),(511,'tumblr','<p>Fantastic word for climate change in German “klimakatastrophe”</p>',1269858674,1219768754,'tumblr',NULL),(512,'tumblr','<a href=\"http://5090.fawm.org/songs.php?id=2303\">Your no one if your not on Twitter</a>',1269858674,1219744067,'tumblr',NULL),(513,'tumblr','<img src=\"http://27.media.tumblr.com/oFlImAcRLcym2jdpvZeOre9N_500.jpg\"/><br/><br/><p>Walking off what seems to be the end of the world.</p>',1269858674,1219425507,'tumblr',NULL),(514,'tumblr','<img src=\"http://29.media.tumblr.com/oFlImAcRLct5l23yBx8Gz0RS_500.jpg\"/><br/><br/><p>I can’t see the peak of Ben Nevis as it’s head is in the clouds. It’s 4,500 feet above sea level, the dotted pigments of Fort William town litter its base. And as time tabled, there’s a hoot hoot from the steam train twice daily.</p>\n<p>It’s the same train as the one filmed in Harry Potter, once the sign for Hogwarts Express is removed after filming, its real name, the Jackle bite, is restored. We might go see that, we were at the scene of Bravehart yesterday evening. It was a 10 minute drive out, below is my favourite photo.</p>',1269858674,1219095487,'tumblr',NULL),(515,'tumblr','<p>Our holiday has got off to a great start. We pulled out of Euston on the sleeper train and checked into the overnight cabin. It was like a padding prison cell with a whole array of free-bees. In the morning we awoke to highland views of Scotland and we ate free breakfast as we wattched it all speeding past the windows. Awsome views.</p>\n<p>My friends were not kidding we can see Ben Nevis from anywhere we stand. Its going to be more difficult to climb than I thought. We will be getting the cable car for sure, More later.</p>',1269858674,1218988994,'tumblr',NULL),(516,'tumblr','<img src=\"http://28.media.tumblr.com/oFlImAcRLco9vyv8zLbpdUaZ_100.jpg\"/><br/><br/><p>I am looking forward to my holiday!</p>',1269858674,1218800384,'tumblr',NULL);
...
-- Dump completed on 2010-03-29 10:33:36
