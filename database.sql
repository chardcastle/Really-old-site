...
CREATE TABLE `kh_posts` (
  ...
  `teaser` text,
  PRIMARY KEY  (`post_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2686 DEFAULT CHARSET=latin1 COMMENT='Stores all posts as json';
SET character_set_client = @saved_cs_client;
...
INSERT INTO `kh_posts` VALUES (2612,'jQuery','Mobile WebKit browsers don\'t support accessing the scroll position of the document/window.',1269872142,1269552613,'gitcommit',NULL),(2613,'jQuery','Need to expose the isLocal change globally as well.',1269872142,1269461773,'gitcommit',NULL),(2614,'jQuery','Temporarily disable ajax tests when running in TestSwam.',1269872142,1269461050,'gitcommit',NULL),(2615,'jQuery','Use custom events for testing unbind instead of the, potentially conflicting, error event.',1269872142,1269459598,'gitcommit',NULL),(2616,'jQuery','Adjust isPlainObject test to run in an iframe.',1269872142,1269458291,'gitcommit',NULL),(2617,'jQuery','Make sure the offset tests work without a built jQuery file.',1269872142,1269376660,'gitcommit',NULL),(2618,'jQuery','Update other remote test URLs as well.',1269872142,1269375891,'gitcommit',NULL),(2619,'jQuery','Strip off filename and query string for JSONP Remote test.',1269872142,1269375729,'gitcommit',NULL),(2620,'jQuery','Update the TestSwarm URL to point to the new jQuery swarm location.',1269872142,1269372102,'gitcommit',NULL),(2621,'jQuery','Changed the order of the tests to run in the same order in which they\'re specified in the Makefile (fixed a dimensions test bug that popped up as a result).',1269872142,1269361900,'gitcommit',NULL),(2622,'jQuery','Handle auto-running of the TestSwarm injection script in the test suite.',1269872142,1269361187,'gitcommit',NULL),(2623,'jQuery','Made it so that you no longer need to build jQuery in order to run the test suite (but you\'ll still need a checkout of QUnit and Sizzle, at least).',1269872142,1269360736,'gitcommit',NULL),(2624,'jQuery','Switch to using String.prototype.trim from String.trim as it\'s more-widely available.',1269872142,1268322559,'gitcommit',NULL),(2625,'jQuery','Rewrote the live/delegate submit tests to be more generic.',1269872142,1268161713,'gitcommit',NULL),(2626,'jQuery','Make sure that special remove and teardown events get called when .die() is used. Additionally made sure that default actions are triggered when namespaced events are used. Fixes #6202 and #6250.',1269872142,1268155345,'gitcommit',NULL),(2627,'jQuery','Removing the mention of buliding the docs from the README. Thanks to \'phihag\' in the forum for the heads-up.',1269872142,1268144195,'gitcommit',NULL),(2628,'jQuery','Landing a faster trim method. Based upon the work by Travis Hardiman and DBJDBJ. More details here: http://forum.jquery.com/topic/faster-jquery-trim Fixes #2279, #4452, and #4835.',1269872142,1268144067,'gitcommit',NULL),(2629,'jQuery','No need to use .call() anymore since we switched from .apply() for appendTo, etc. Thanks to Robert in 2c08004f6d4e7f11a875190e132d204a25cb9418 for the heads-up.',1269872142,1267801198,'gitcommit',NULL),(2630,'jQuery','I take that back! It was a bug, but the cache had to be triggered and a collection of cached nodes had to be passed in (an odd case to be sure). Fixes #6227.',1269872142,1267766087,'gitcommit',NULL),(2631,'jQuery','Attempted to fix #6227, not entirely sure if it\'s a problem as I\'m having a hard time reproducing it. Regardless, the change is harmless and potentially even speeds up appendTo, etc. slightly.',1269872142,1267765677,'gitcommit',NULL),(2632,'jQuery','Added in Ben Alman\'s proposed event.namespace property (the property holds the namespaces specified in a call to trigger). Additionally fixes namespaces with .live(). Fixes #6208 and #6209.',1269872142,1267569252,'gitcommit',NULL),(2633,'jQuery','Make sure that we don\'t try to remove data from an applet. Re-Fixes #1675.',1269872142,1267556175,'gitcommit',NULL),(2634,'jQuery','Add in the new level information to the closest(Array) test.',1269872142,1267545234,'gitcommit',NULL),(2635,'jQuery','We no longer support globally-triggered events on plain objects. This is a trade-off to having good garbage collection on the objects.',1269872142,1267545091,'gitcommit',NULL),(2636,'jQuery','Moving more properties onto jQuery.ajax, also copy them back to the jQuery object for backwards compatibility.',1269872142,1267544688,'gitcommit',NULL),(2637,'jQuery','Remove the need for the return in sizzle-jquery and just remove the attempt to expose Sizzle completely. jQuery is 100% passing JSLint (\'make lint\') now.',1269872142,1267498568,'gitcommit',NULL),(2638,'jQuery','Added in integrated JSLint checking against the jQuery source. Just run \'make lint\' to see the result.',1269872142,1267498304,'gitcommit',NULL),(2639,'jQuery','More changes to get jQuery in line with JSLint.',1269872142,1267496689,'gitcommit',NULL),(2640,'jQuery','We don\'t want to increment the Ajax counter if there isn\'t a global event.',1269872142,1267489873,'gitcommit',NULL),(2641,'jQuery','Land some additional tweaks related to running through JSLint.',1269872142,1267485569,'gitcommit',NULL),(2642,'tweet','hardcastle: It\'s 4am and our house it littered with patches of baby puke #eeeew #WorseThanPoop',1269872142,1269746426,'tweet',NULL),(2643,'tweet','hardcastle: @glynroberts #jailbreak sounds great, shame I\'m too late :( was at dads group with luke :)',1269872142,1269704966,'tweet',NULL),(2644,'tweet','hardcastle: @glynroberts look at pixelotto which I think was grown from little funding into a success',1269872142,1269704704,'tweet',NULL),(2645,'tweet','hardcastle: loving the #spooktreasurehunt',1269872142,1269621456,'tweet',NULL),(2646,'tweet','hardcastle: @calypsomustdie no-way, that\'s awsum! It must be #tfif #spookhunt GAME ON!',1269872142,1269617906,'tweet',NULL),(2647,'tweet','hardcastle: &lt;bugs&gt;GITHub cost me a bank fine. USB Stick won\'t format. My space bar has fallen out.&lt;/bugs&gt; --&gt; what next?',1269872142,1269551491,'tweet',NULL),(2648,'tweet','hardcastle: Install the magnatune iPhone app For #free #music, like spotify (smaller library)',1269872142,1269547128,'tweet',NULL),(2649,'tweet','hardcastle: “All programmers are playwrights and all computers are lousy actors.” - unkown',1269872142,1269479533,'tweet',NULL),(2650,'tweet','hardcastle: @andygirvan RE jQ-ui 1.8 my fav features are \"explode\" and backgroundColor animate',1269872142,1269431405,'tweet',NULL),(2651,'tweet','hardcastle: @jevillustration queens more like... Where\'s the cheezburger at?',1269872142,1269202801,'tweet',NULL),(2652,'tweet','hardcastle: I\'m having fun with the tumblr iTouch app, but the navigation is a little poor IMHO',1269872142,1269168667,'tweet',NULL),(2653,'tweet','hardcastle: What kind of a programmer are you? http://bit.ly/5sJSZ0',1269872142,1269123166,'tweet',NULL),(2654,'tweet','hardcastle: Just been handed a new project titled \"Project freedom!\"',1269872142,1269001876,'tweet',NULL),(2655,'tweet','hardcastle: @spol wu-ho Every thing I know about .NET is off stackoverflow. I\'m sure that will help :)',1269872142,1268920000,'tweet',NULL),(2656,'tweet','hardcastle: Requesting object JSON from LINQ via AJAX, it\'s very fast, fun and so easy! For now.',1269872142,1268911779,'tweet',NULL),(2657,'tweet','hardcastle: \"If you make it idiot proof, they\'ll build a better idiot\" - unknown',1269872142,1268821938,'tweet',NULL),(2658,'tweet','hardcastle: Just sending @andygirvan a GIT bundle as documented here http://bit.ly/bN2gWp I love to share code!',1269872142,1268776633,'tweet',NULL),(2659,'tweet','hardcastle: Our kid\'s got a blocked nose. He\'s asleep in his cot and sounds like baby Darth Vader. #awww',1269872142,1268773463,'tweet',NULL),(2660,'tweet','hardcastle: RT @trs21219: @philsturgeon git clone jessica alba; git checkout -b ass; --&gt; git archive kelly brooke',1269872142,1268771686,'tweet',NULL),(2661,'tweet','hardcastle: @calypsomustdie as a contestant or galidiator?',1269872142,1268512954,'tweet',NULL),(2662,'regular','{\"@attributes\":{\"date\":\"Fri, 26 Mar 2010 10:33:00\",\"date-gmt\":\"2010-03-26 14:33:00 GMT\",\"format\":\"html\",\"id\":\"474835129\",\"reblog-key\":\"GVR520tH\",\"slug\":\"a-letter-to-tech-support\",\"type\":\"regular\",\"unix-timestamp\":\"1269613980\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/474835129\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/474835129\\/a-letter-to-tech-support\"},\"regular-title\":\"A letter to tech support\",\"regular-body\":\"<p><a href=\\\"http:\\/\\/fuckyeahcomputerscience.tumblr.com\\/post\\/304069328\\/xd\\\">fuckyeahcomputerscience<\\/a>:<\\/p>\\n<blockquote>\\n<p><a href=\\\"http:\\/\\/ayiie.tumblr.com\\/post\\/304048865\\/xd\\\">ayiie<\\/a>:<\\/p>\\n<blockquote>\\n<p>Dear Tech Support:<br\\/>Last year I upgraded from Girlfriend 7.0 to Wife 1.0. I soon noticed that the new program began unexpected child processing that took up a lot of space and resources. In addition, Wife 1.0 installed itself into all other programs and now monitors all other system activity. Applications such as Poker Night 10.3, Football 5.0, HuntingAndFishing 7.5, and Racing 3.6. I can\\u2019t seem to keep Wife 1.0 in the background while attempting to run my favorite applications. I\\u2019m thinking about going back to Girlfriend 7.0, but the uninstall doesn\\u2019t work on Wife 1.0. Please help!<!-- more --><br\\/><br\\/>Thanks \\u2026Troubled User<br\\/>\\u2014\\u2014\\u2014-<br\\/>REPLY:<br\\/><br\\/>Dear Troubled User:<br\\/>This is a very common problem. Many people upgrade from Girlfriend 7.0 to Wife 1.0, thinking that it is just a Utilities and Entertainment program. Wife 1.0 is an OPERATING SYSTEM and is designed by its Creator to run EVERYTHING!!! It is also impossible to delete Wife 1.0 and to return to Girlfriend 7.0. It is impossible to uninstall, or purge the program files from the system once installed. You cannot go back to Girlfriend 7.0 because Wife 1.0 is designed not to allow this. Look in your Wife 1.0 manual under Warnings-Alimony-Child Support. I recommend that you keep Wife 1.0 installed and work on improving the configuration. I suggest installing the background application YesDear 99.0 to alleviate software augmentation.<br\\/><br\\/>The best course of action is to enter the command C:APOLOGIZE because ultimately you will have to do this before the system will return to normal anyway.<br\\/><br\\/>Wife 1.0 is a great program, but it tends to be very high maintenance. Wife 1.0 comes with several support programs, such as CleanAndSweep 3.0, CookIt 1.5 and DoBills 4.2. However, be very careful how you use these programs. Improper use will cause the system to launch the program NagNag 9.5. Once this happens, the only way to improve the performance of Wife 1.0 is to purchase additional software. I recommend Flowers 2.1 and Diamonds 5.0, but beware because sometimes these applications can be expensive.<br\\/><br\\/>WARNING!!! DO NOT, under any circumstances, install SecretaryWithShortSkirt 3.3. This application is not supported by Wife 1.0 and will cause irreversible damage to the operating system.<\\/p>\\n<p>WARNING!!! Attempting to install NewGirlFriend 8.8 along with Wife 1.0 will crash the system.<br\\/><br\\/>(see Wife 1.0 manual, Apologize, High Maintenance &amp; Secretary with Short Skirt)<\\/p>\\n<p>=)) Gets nyo xD<\\/p>\\n<\\/blockquote>\\n<\\/blockquote>\"}',1269872142,1269599580,'tumblr','<p>Dear Tech Support:<br\\/>Last year I upgraded from Girlfriend 7.0 to Wife 1.0. I soon noticed that the new program began unexpected child processing that took up a lot of space and resources. In addition, Wife 1.0 installed itself into all other programs and now monitors all other system activity. Applications such as Poker Night 10.3, Football 5.0, HuntingAndFishing 7.5, and Racing 3.6. I can\\u2019t seem to keep Wife 1.0 in the background while attempting to run my favorite applications. I\\u2019m thinking about going back to Girlfriend 7.0, but the uninstall doesn\\u2019t work on Wife 1.0. Please help!</p>'),(2680,'jQuery','Removed extra semicolon leftover from recent tweaking.',1270245917,1270060584,'gitcommit',NULL),(2681,'tweet','hardcastle: OMG go to XKCD NOW!',1270245917,1270141159,'tweet',NULL),(2682,'tweet','hardcastle: Had a look at heroku.com today, looks fun to try. #git #ruby',1270245917,1269988897,'tweet',NULL),(2683,'tweet','hardcastle: We won champagne at the Google London head quarters for wine tasting!',1270245917,1269975454,'tweet',NULL),(2684,'tweet','hardcastle: @glynroberts I think you would be great in the next season... Gleeyn #glee',1270245917,1269905731,'tweet',NULL),(2685,'regular','{\"@attributes\":{\"date\":\"Thu, 01 Apr 2010 13:31:13\",\"date-gmt\":\"2010-04-01 17:31:13 GMT\",\"feed-item\":\"http:\\/\\/twitter.com\\/hardcastle\\/statuses\\/11434374481\",\"format\":\"html\",\"from-feed-id\":\"259141\",\"id\":\"489399525\",\"reblog-key\":\"S9YLsIuS\",\"slug\":\"omg-go-to-xkcd-now\",\"type\":\"regular\",\"unix-timestamp\":\"1270143073\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/489399525\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/489399525\\/omg-go-to-xkcd-now\"},\"regular-body\":\"<p>OMG go to XKCD NOW!<\\/p>\"}',1270245917,1270125073,'tumblr',NULL),(2663,'photo','{\"@attributes\":{\"date\":\"Sun, 21 Mar 2010 18:49:41\",\"date-gmt\":\"2010-03-21 22:49:41 GMT\",\"format\":\"html\",\"id\":\"464210746\",\"reblog-key\":\"uJ1qsfYR\",\"slug\":\"\",\"type\":\"photo\",\"unix-timestamp\":\"1269211781\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/464210746\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/464210746\",\"small\":\"http:\\/\\/26.media.tumblr.com\\/tumblr_kznm2uEavc1qzpuawo1_250.png\",\"tiny\":\"http:\\/\\/26.media.tumblr.com\\/tumblr_kznm2uEavc1qzpuawo1_75sq.png\"},\"photo-url\":[\"http:\\/\\/26.media.tumblr.com\\/tumblr_kznm2uEavc1qzpuawo1_400.png\",\"http:\\/\\/26.media.tumblr.com\\/tumblr_kznm2uEavc1qzpuawo1_400.png\",\"http:\\/\\/26.media.tumblr.com\\/tumblr_kznm2uEavc1qzpuawo1_400.png\",\"http:\\/\\/26.media.tumblr.com\\/tumblr_kznm2uEavc1qzpuawo1_250.png\",\"http:\\/\\/28.media.tumblr.com\\/tumblr_kznm2uEavc1qzpuawo1_100.png\",\"http:\\/\\/26.media.tumblr.com\\/tumblr_kznm2uEavc1qzpuawo1_75sq.png\"]}',1269872142,1269197381,'tumblr',NULL),(2664,'photo','{\"@attributes\":{\"date\":\"Tue, 09 Mar 2010 14:55:02\",\"date-gmt\":\"2010-03-09 19:55:02 GMT\",\"format\":\"html\",\"id\":\"437319934\",\"reblog-key\":\"4dFgKWPA\",\"slug\":\"ive-never-felt-so-proud-of-our-family-name-than\",\"type\":\"photo\",\"unix-timestamp\":\"1268164502\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/437319934\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/437319934\\/ive-never-felt-so-proud-of-our-family-name-than\",\"large\":\"http:\\/\\/30.media.tumblr.com\\/tumblr_kz15zqGEkr1qzpuawo1_500.jpg\",\"small\":\"http:\\/\\/30.media.tumblr.com\\/tumblr_kz15zqGEkr1qzpuawo1_250.jpg\",\"tiny\":\"http:\\/\\/27.media.tumblr.com\\/tumblr_kz15zqGEkr1qzpuawo1_75sq.jpg\"},\"photo-caption\":\"<p>I&#8217;ve never felt so proud of our family name than to discover that such a TV was ever conceived. Absolute win with Hardcastle plastered all over it.<\\/p>\",\"photo-url\":[\"http:\\/\\/30.media.tumblr.com\\/tumblr_kz15zqGEkr1qzpuawo1_500.jpg\",\"http:\\/\\/30.media.tumblr.com\\/tumblr_kz15zqGEkr1qzpuawo1_500.jpg\",\"http:\\/\\/28.media.tumblr.com\\/tumblr_kz15zqGEkr1qzpuawo1_400.jpg\",\"http:\\/\\/30.media.tumblr.com\\/tumblr_kz15zqGEkr1qzpuawo1_250.jpg\",\"http:\\/\\/26.media.tumblr.com\\/tumblr_kz15zqGEkr1qzpuawo1_100.jpg\",\"http:\\/\\/27.media.tumblr.com\\/tumblr_kz15zqGEkr1qzpuawo1_75sq.jpg\"]}',1269872142,1268146502,'tumblr',NULL),(2665,'photo','{\"@attributes\":{\"date\":\"Sun, 19 Oct 2008 16:44:19\",\"date-gmt\":\"2008-10-19 20:44:19 GMT\",\"format\":\"html\",\"id\":\"55331538\",\"reblog-key\":\"goAPTgPN\",\"slug\":\"this-is-ruth-performing-at-the-famous-100-club-in\",\"type\":\"photo\",\"unix-timestamp\":\"1224449059\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/55331538\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/55331538\\/this-is-ruth-performing-at-the-famous-100-club-in\",\"large\":\"http:\\/\\/28.media.tumblr.com\\/oFlImAcRLf9oyod5XgRCAkP9o1_500.jpg\",\"small\":\"http:\\/\\/24.media.tumblr.com\\/oFlImAcRLf9oyod5XgRCAkP9o1_250.jpg\",\"tiny\":\"http:\\/\\/30.media.tumblr.com\\/oFlImAcRLf9oyod5XgRCAkP9o1_75sq.jpg\"},\"photo-caption\":\"<p>This is Ruth performing at the famous 100 club in Oxford street. It was a great night.<\\/p>\",\"photo-url\":[\"http:\\/\\/28.media.tumblr.com\\/oFlImAcRLf9oyod5XgRCAkP9o1_500.jpg\",\"http:\\/\\/28.media.tumblr.com\\/oFlImAcRLf9oyod5XgRCAkP9o1_500.jpg\",\"http:\\/\\/27.media.tumblr.com\\/oFlImAcRLf9oyod5XgRCAkP9o1_400.jpg\",\"http:\\/\\/24.media.tumblr.com\\/oFlImAcRLf9oyod5XgRCAkP9o1_250.jpg\",\"http:\\/\\/25.media.tumblr.com\\/oFlImAcRLf9oyod5XgRCAkP9o1_100.jpg\",\"http:\\/\\/30.media.tumblr.com\\/oFlImAcRLf9oyod5XgRCAkP9o1_75sq.jpg\"]}',1269872142,1224431059,'tumblr',NULL),(2666,'regular','{\"@attributes\":{\"date\":\"Sun, 12 Oct 2008 09:44:17\",\"date-gmt\":\"2008-10-12 13:44:17 GMT\",\"feed-item\":\"http:\\/\\/twitter.com\\/hardcastle\\/statuses\\/955336529\",\"format\":\"html\",\"from-feed-id\":\"259141\",\"id\":\"54203504\",\"reblog-key\":\"jUHSHOdk\",\"slug\":\"why-i-am-being-bitten-my-mosquitoes-in-the-middle\",\"type\":\"regular\",\"unix-timestamp\":\"1223819057\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/54203504\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/54203504\\/why-i-am-being-bitten-my-mosquitoes-in-the-middle\"},\"regular-body\":\"<p>Why I am being bitten my mosquitoes in the middle of rocktober?<\\/p>\"}',1269872142,1223801057,'tumblr',NULL),(2667,'link','{\"@attributes\":{\"date\":\"Tue, 30 Sep 2008 16:46:47\",\"date-gmt\":\"2008-09-30 20:46:47 GMT\",\"format\":\"html\",\"id\":\"52490976\",\"reblog-key\":\"KZRHZ0yF\",\"slug\":\"yes-you-can-haz-music\",\"type\":\"link\",\"unix-timestamp\":\"1222807607\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/52490976\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/52490976\\/yes-you-can-haz-music\"},\"link-text\":\"Yes you can haz music\",\"link-url\":\"http:\\/\\/guerillaradio.net\\/\"}',1269872142,1222789607,'tumblr',NULL),(2668,'video','{\"@attributes\":{\"date\":\"Tue, 30 Sep 2008 16:36:36\",\"date-gmt\":\"2008-09-30 20:36:36 GMT\",\"format\":\"html\",\"id\":\"52489825\",\"reblog-key\":\"r5OjtmBk\",\"slug\":\"a-touch-of-genius-for-those-who-love-bass-guitar\",\"type\":\"video\",\"unix-timestamp\":\"1222806996\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/52489825\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/52489825\\/a-touch-of-genius-for-those-who-love-bass-guitar\"},\"video-caption\":\"<p>A touch of genius for those who love bass guitar. What a tune, perfect for walking down the street on a sunny day.<\\/p>\",\"video-source\":\"http:\\/\\/uk.youtube.com\\/watch?v=q8Z--jWWFVw&feature=related\",\"video-player\":\"<object width=\\\"400\\\" height=\\\"336\\\"><param name=\\\"movie\\\" value=\\\"http:\\/\\/www.youtube.com\\/v\\/q8Z--jWWFVw&amp;rel=0&amp;egm=0&amp;showinfo=0&amp;fs=1\\\"><\\/param><param name=\\\"wmode\\\" value=\\\"transparent\\\"><\\/param><param name=\\\"allowFullScreen\\\" value=\\\"true\\\"><\\/param><embed src=\\\"http:\\/\\/www.youtube.com\\/v\\/q8Z--jWWFVw&amp;rel=0&amp;egm=0&amp;showinfo=0&amp;fs=1\\\" type=\\\"application\\/x-shockwave-flash\\\" width=\\\"400\\\" height=\\\"336\\\" allowFullScreen=\\\"true\\\" wmode=\\\"transparent\\\"><\\/embed><\\/object>\"}',1269872142,1222788996,'tumblr',NULL),(2669,'regular','{\"@attributes\":{\"date\":\"Sun, 31 Aug 2008 12:49:16\",\"date-gmt\":\"2008-08-31 16:49:16 GMT\",\"format\":\"html\",\"id\":\"48169743\",\"reblog-key\":\"7U1IZpK1\",\"slug\":\"to-www-or-not-to-www\",\"type\":\"regular\",\"unix-timestamp\":\"1220201356\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/48169743\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/48169743\\/to-www-or-not-to-www\"},\"regular-title\":\"To www or not to www?\",\"regular-body\":\"<blockquote>\\n<p>&#8220;Requiring employees to type &#8216;WWW&#8217; cost companies over $25 billion last year,&#8221; said ICANN representative Emil Scharnsdorf. &#8220;The average Internet surfer takes two seconds to type &#8216;www&#8217; and visits 125 sites a day, add in typos like &#8220;qqq&#8221; and &#8220;ww,&#8221; then wave your hands over your head three times and you&#8217;re at $25 billion.&#8221;<\\/p>\\n<p>&#8220;We&#8217;re only concerned with the Internet, but it takes Mandy Patinkin three seconds to say &#8216;www&#8217; and during the Super Bowl that gets expensive.&#8221;<\\/p>\\n<p><a title=\\\"Source\\\" href=\\\"http:\\/\\/codeclimber.net.nz\\/archive\\/2007\\/09\\/28\\/To-www-or-not-to-www.aspx\\\">source<\\/a><\\/p>\\n\\n\\n<\\/blockquote>\"}',1269872142,1220183356,'tumblr',NULL),(2670,'regular','{\"@attributes\":{\"date\":\"Fri, 29 Aug 2008 19:49:03\",\"date-gmt\":\"2008-08-29 23:49:03 GMT\",\"format\":\"html\",\"id\":\"47977607\",\"reblog-key\":\"3caGWNcz\",\"slug\":\"i-went-to-a-party-tonight-and\",\"type\":\"regular\",\"unix-timestamp\":\"1220053743\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/47977607\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/47977607\\/i-went-to-a-party-tonight-and\"},\"regular-title\":\"I went to a party tonight and ...\",\"regular-body\":\"<p>I mentioned something I quite often use during a conversation about the internet. The Romans built roads, the Victorians built railways and we. Today build the information super highway [yuk - (i mean the web)] - just thought I would share that.<\\/p>\"}',1269872142,1220035743,'tumblr',NULL),(2671,'photo','{\"@attributes\":{\"date\":\"Thu, 28 Aug 2008 07:44:47\",\"date-gmt\":\"2008-08-28 11:44:47 GMT\",\"format\":\"html\",\"id\":\"47757561\",\"reblog-key\":\"wJGbDWWy\",\"slug\":\"frank-and-annie-performed-last-night-at-the-old\",\"type\":\"photo\",\"unix-timestamp\":\"1219923887\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/47757561\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/47757561\\/frank-and-annie-performed-last-night-at-the-old\",\"large\":\"http:\\/\\/26.media.tumblr.com\\/oFlImAcRLd6usj9iFb5AmxjX_500.jpg\",\"small\":\"http:\\/\\/29.media.tumblr.com\\/oFlImAcRLd6usj9iFb5AmxjX_250.jpg\",\"tiny\":\"http:\\/\\/24.media.tumblr.com\\/oFlImAcRLd6usj9iFb5AmxjX_75sq.jpg\"},\"photo-caption\":\"<p>Frank and Annie performed last night at the old nun&#8217;s head. Nunhead, Lodon. They were fantastic!<\\/p>\",\"photo-url\":[\"http:\\/\\/26.media.tumblr.com\\/oFlImAcRLd6usj9iFb5AmxjX_500.jpg\",\"http:\\/\\/26.media.tumblr.com\\/oFlImAcRLd6usj9iFb5AmxjX_500.jpg\",\"http:\\/\\/26.media.tumblr.com\\/oFlImAcRLd6usj9iFb5AmxjX_400.jpg\",\"http:\\/\\/29.media.tumblr.com\\/oFlImAcRLd6usj9iFb5AmxjX_250.jpg\",\"http:\\/\\/24.media.tumblr.com\\/oFlImAcRLd6usj9iFb5AmxjX_100.jpg\",\"http:\\/\\/24.media.tumblr.com\\/oFlImAcRLd6usj9iFb5AmxjX_75sq.jpg\"]}',1269872142,1219905887,'tumblr',NULL),(2672,'photo','{\"@attributes\":{\"date\":\"Thu, 28 Aug 2008 07:37:57\",\"date-gmt\":\"2008-08-28 11:37:57 GMT\",\"format\":\"html\",\"id\":\"47757170\",\"reblog-key\":\"9921UrBZ\",\"slug\":\"last-night-i-thought-ruth-looked-like-a-hindu\",\"type\":\"photo\",\"unix-timestamp\":\"1219923477\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/47757170\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/47757170\\/last-night-i-thought-ruth-looked-like-a-hindu\",\"large\":\"http:\\/\\/28.media.tumblr.com\\/oFlImAcRLd6ujr313aLnfQPL_500.jpg\",\"small\":\"http:\\/\\/27.media.tumblr.com\\/oFlImAcRLd6ujr313aLnfQPL_250.jpg\",\"tiny\":\"http:\\/\\/27.media.tumblr.com\\/oFlImAcRLd6ujr313aLnfQPL_75sq.jpg\"},\"photo-caption\":\"<p>Last night, I thought ruth looked like a hindu goodess. Now that I am sober, it&#8217;s a terrible picture of my gorgeous wife.<\\/p>\",\"photo-url\":[\"http:\\/\\/28.media.tumblr.com\\/oFlImAcRLd6ujr313aLnfQPL_500.jpg\",\"http:\\/\\/28.media.tumblr.com\\/oFlImAcRLd6ujr313aLnfQPL_500.jpg\",\"http:\\/\\/28.media.tumblr.com\\/oFlImAcRLd6ujr313aLnfQPL_400.jpg\",\"http:\\/\\/27.media.tumblr.com\\/oFlImAcRLd6ujr313aLnfQPL_250.jpg\",\"http:\\/\\/30.media.tumblr.com\\/oFlImAcRLd6ujr313aLnfQPL_100.jpg\",\"http:\\/\\/27.media.tumblr.com\\/oFlImAcRLd6ujr313aLnfQPL_75sq.jpg\"]}',1269872142,1219905477,'tumblr',NULL),(2673,'photo','{\"@attributes\":{\"date\":\"Wed, 27 Aug 2008 12:35:16\",\"date-gmt\":\"2008-08-27 16:35:16 GMT\",\"format\":\"html\",\"id\":\"47637161\",\"reblog-key\":\"PouA0JAd\",\"slug\":\"the-latest-scan-12-weeks-baby-installation\",\"type\":\"photo\",\"unix-timestamp\":\"1219854916\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/47637161\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/47637161\\/the-latest-scan-12-weeks-baby-installation\",\"large\":\"http:\\/\\/26.media.tumblr.com\\/oFlImAcRLd5pq9hxjb2GYcQT_500.jpg\",\"small\":\"http:\\/\\/25.media.tumblr.com\\/oFlImAcRLd5pq9hxjb2GYcQT_250.jpg\",\"tiny\":\"http:\\/\\/27.media.tumblr.com\\/oFlImAcRLd5pq9hxjb2GYcQT_75sq.jpg\"},\"photo-caption\":\"<p>The latest scan @ 12 weeks! Baby installation nearly complete.<\\/p>\",\"photo-url\":[\"http:\\/\\/26.media.tumblr.com\\/oFlImAcRLd5pq9hxjb2GYcQT_500.jpg\",\"http:\\/\\/26.media.tumblr.com\\/oFlImAcRLd5pq9hxjb2GYcQT_500.jpg\",\"http:\\/\\/24.media.tumblr.com\\/oFlImAcRLd5pq9hxjb2GYcQT_400.jpg\",\"http:\\/\\/25.media.tumblr.com\\/oFlImAcRLd5pq9hxjb2GYcQT_250.jpg\",\"http:\\/\\/25.media.tumblr.com\\/oFlImAcRLd5pq9hxjb2GYcQT_100.jpg\",\"http:\\/\\/27.media.tumblr.com\\/oFlImAcRLd5pq9hxjb2GYcQT_75sq.jpg\"]}',1269872142,1219836916,'tumblr',NULL),(2674,'regular','{\"@attributes\":{\"date\":\"Tue, 26 Aug 2008 12:39:14\",\"date-gmt\":\"2008-08-26 16:39:14 GMT\",\"feed-item\":\"http:\\/\\/twitter.com\\/hardcastle\\/statuses\\/899413209\",\"format\":\"html\",\"from-feed-id\":\"259141\",\"id\":\"47485187\",\"reblog-key\":\"XVK2SK9K\",\"slug\":\"fantastic-word-for-climate-change-in-german\",\"type\":\"regular\",\"unix-timestamp\":\"1219768754\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/47485187\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/47485187\\/fantastic-word-for-climate-change-in-german\"},\"regular-body\":\"<p>Fantastic word for climate change in German &#8220;klimakatastrophe&#8221;<\\/p>\"}',1269872142,1219750754,'tumblr',NULL),(2675,'link','{\"@attributes\":{\"date\":\"Tue, 26 Aug 2008 05:47:47\",\"date-gmt\":\"2008-08-26 09:47:47 GMT\",\"format\":\"html\",\"id\":\"47439276\",\"reblog-key\":\"PHDm65iO\",\"slug\":\"your-no-one-if-your-not-on-twitter\",\"type\":\"link\",\"unix-timestamp\":\"1219744067\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/47439276\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/47439276\\/your-no-one-if-your-not-on-twitter\"},\"link-text\":\"Your no one if your not on Twitter\",\"link-url\":\"http:\\/\\/5090.fawm.org\\/songs.php?id=2303\"}',1269872142,1219726067,'tumblr',NULL),(2676,'photo','{\"@attributes\":{\"date\":\"Fri, 22 Aug 2008 13:18:27\",\"date-gmt\":\"2008-08-22 17:18:27 GMT\",\"format\":\"html\",\"id\":\"46994389\",\"reblog-key\":\"8yiIM1BU\",\"slug\":\"walking-off-what-seems-to-be-the-end-of-the-world\",\"type\":\"photo\",\"unix-timestamp\":\"1219425507\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/46994389\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/46994389\\/walking-off-what-seems-to-be-the-end-of-the-world\",\"large\":\"http:\\/\\/27.media.tumblr.com\\/oFlImAcRLcym2jdpvZeOre9N_500.jpg\",\"small\":\"http:\\/\\/30.media.tumblr.com\\/oFlImAcRLcym2jdpvZeOre9N_250.jpg\",\"tiny\":\"http:\\/\\/24.media.tumblr.com\\/oFlImAcRLcym2jdpvZeOre9N_75sq.jpg\"},\"photo-caption\":\"<p>Walking off what seems to be the end of the world.<\\/p>\",\"photo-url\":[\"http:\\/\\/27.media.tumblr.com\\/oFlImAcRLcym2jdpvZeOre9N_500.jpg\",\"http:\\/\\/27.media.tumblr.com\\/oFlImAcRLcym2jdpvZeOre9N_500.jpg\",\"http:\\/\\/25.media.tumblr.com\\/oFlImAcRLcym2jdpvZeOre9N_400.jpg\",\"http:\\/\\/30.media.tumblr.com\\/oFlImAcRLcym2jdpvZeOre9N_250.jpg\",\"http:\\/\\/30.media.tumblr.com\\/oFlImAcRLcym2jdpvZeOre9N_100.jpg\",\"http:\\/\\/24.media.tumblr.com\\/oFlImAcRLcym2jdpvZeOre9N_75sq.jpg\"]}',1269872142,1219407507,'tumblr',NULL),(2677,'photo','{\"@attributes\":{\"date\":\"Mon, 18 Aug 2008 17:38:07\",\"date-gmt\":\"2008-08-18 21:38:07 GMT\",\"format\":\"html\",\"id\":\"46462028\",\"reblog-key\":\"ZtMCOtEp\",\"slug\":\"i-cant-see-the-peak-of-ben-nevis-as-its-head-is\",\"type\":\"photo\",\"unix-timestamp\":\"1219095487\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/46462028\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/46462028\\/i-cant-see-the-peak-of-ben-nevis-as-its-head-is\",\"large\":\"http:\\/\\/29.media.tumblr.com\\/oFlImAcRLct5l23yBx8Gz0RS_500.jpg\",\"small\":\"http:\\/\\/28.media.tumblr.com\\/oFlImAcRLct5l23yBx8Gz0RS_250.jpg\",\"tiny\":\"http:\\/\\/26.media.tumblr.com\\/oFlImAcRLct5l23yBx8Gz0RS_75sq.jpg\"},\"photo-caption\":\"<p>I can&#8217;t see the peak of Ben Nevis as it&#8217;s head is in the clouds. It&#8217;s 4,500 feet above sea level, the dotted pigments of Fort William town litter its base. And as time tabled, there&#8217;s a hoot hoot from the steam train twice daily.<\\/p>\\n<p>It&#8217;s the same train as the one filmed in Harry Potter, once the sign for Hogwarts Express is removed after filming, its real name, the Jackle bite, is restored. We might go see that, we were at the scene of Bravehart yesterday evening. It was a 10 minute drive out, below is my favourite photo.<\\/p>\",\"photo-url\":[\"http:\\/\\/29.media.tumblr.com\\/oFlImAcRLct5l23yBx8Gz0RS_500.jpg\",\"http:\\/\\/29.media.tumblr.com\\/oFlImAcRLct5l23yBx8Gz0RS_500.jpg\",\"http:\\/\\/28.media.tumblr.com\\/oFlImAcRLct5l23yBx8Gz0RS_400.jpg\",\"http:\\/\\/28.media.tumblr.com\\/oFlImAcRLct5l23yBx8Gz0RS_250.jpg\",\"http:\\/\\/25.media.tumblr.com\\/oFlImAcRLct5l23yBx8Gz0RS_100.jpg\",\"http:\\/\\/26.media.tumblr.com\\/oFlImAcRLct5l23yBx8Gz0RS_75sq.jpg\"]}',1269872142,1219077487,'tumblr',NULL),(2678,'regular','{\"@attributes\":{\"date\":\"Sun, 17 Aug 2008 12:03:14\",\"date-gmt\":\"2008-08-17 16:03:14 GMT\",\"format\":\"html\",\"id\":\"46303919\",\"reblog-key\":\"BH5ZIhtB\",\"slug\":\"in-scotland\",\"type\":\"regular\",\"unix-timestamp\":\"1218988994\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/46303919\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/46303919\\/in-scotland\"},\"regular-title\":\"In Scotland\",\"regular-body\":\"<p>Our holiday has got off to a great start. We pulled out of Euston on the sleeper train and checked into the overnight cabin. It was like a padding prison cell with a whole array of free-bees. In the morning we awoke to highland views of Scotland and we ate free breakfast as we wattched it all speeding past the windows. Awsome views.<\\/p>\\n<p>My friends were not kidding we can see Ben Nevis from anywhere we stand. Its going to be more difficult to climb than I thought. We will be getting the cable car for sure, More later.<\\/p>\"}',1269872142,1218970994,'tumblr',NULL),(2679,'photo','{\"@attributes\":{\"date\":\"Fri, 15 Aug 2008 07:39:44\",\"date-gmt\":\"2008-08-15 11:39:44 GMT\",\"format\":\"html\",\"id\":\"46062654\",\"reblog-key\":\"WmHgRVns\",\"slug\":\"i-am-looking-forward-to-my-holiday\",\"type\":\"photo\",\"unix-timestamp\":\"1218800384\",\"url\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/46062654\",\"url-with-slug\":\"http:\\/\\/hardcastle.tumblr.com\\/post\\/46062654\\/i-am-looking-forward-to-my-holiday\",\"tiny\":\"http:\\/\\/28.media.tumblr.com\\/oFlImAcRLco9vyv8zLbpdUaZ_75sq.jpg\"},\"photo-caption\":\"<p>I am looking forward to my holiday!<\\/p>\",\"photo-url\":[\"http:\\/\\/28.media.tumblr.com\\/oFlImAcRLco9vyv8zLbpdUaZ_100.jpg\",\"http:\\/\\/28.media.tumblr.com\\/oFlImAcRLco9vyv8zLbpdUaZ_100.jpg\",\"http:\\/\\/28.media.tumblr.com\\/oFlImAcRLco9vyv8zLbpdUaZ_100.jpg\",\"http:\\/\\/28.media.tumblr.com\\/oFlImAcRLco9vyv8zLbpdUaZ_100.jpg\",\"http:\\/\\/28.media.tumblr.com\\/oFlImAcRLco9vyv8zLbpdUaZ_100.jpg\",\"http:\\/\\/28.media.tumblr.com\\/oFlImAcRLco9vyv8zLbpdUaZ_75sq.jpg\"]}',1269872142,1218782384,'tumblr',NULL);
/*!40000 ALTER TABLE `kh_posts` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `kh_timeline`
--

DROP TABLE IF EXISTS `kh_timeline`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE TABLE `kh_timeline` (
  `id` int(11) NOT NULL auto_increment,
  `date` varchar(30) NOT NULL,
  `content` text NOT NULL COMMENT 'Array of the total content as built by its object, stored as json',
  `squence_id` int(11) NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=34 DEFAULT CHARSET=latin1 COMMENT='A view of all the post source records stored in kh_posts';
SET character_set_client = @saved_cs_client;

--
-- Dumping data for table `kh_timeline`
--

LOCK TABLES `kh_timeline` WRITE;
/*!40000 ALTER TABLE `kh_timeline` DISABLE KEYS */;
INSERT INTO `kh_timeline` VALUES (1,'01st Apr 10','[\"hardcastle: OMG go to XKCD NOW!\",\"<h3><\\/h3>\\n<p>OMG go to XKCD NOW!<\\/p>\\n\"]',1),(2,'31st Mar 10','[\"Removed extra semicolon leftover from recent tweaking.\"]',2),(3,'30th Mar 10','[\"hardcastle: Had a look at heroku.com today, looks fun to try. #git #ruby\",\"hardcastle: We won champagne at the Google London head quarters for wine tasting!\",\"hardcastle: @glynroberts I think you would be great in the next season... Gleeyn #glee\"]',3),(4,'28th Mar 10','[\"hardcastle: It\'s 4am and our house it littered with patches of baby puke #eeeew #WorseThanPoop\"]',4),(5,'27th Mar 10','[\"hardcastle: @glynroberts #jailbreak sounds great, shame I\'m too late :( was at dads group with luke :)\",\"hardcastle: @glynroberts look at pixelotto which I think was grown from little funding into a success\"]',5),(6,'26th Mar 10','[\"hardcastle: loving the #spooktreasurehunt\",\"hardcastle: @calypsomustdie no-way, that\'s awsum! It must be #tfif #spookhunt GAME ON!\",\"<h3>A letter to tech support<\\/h3>\\n<p>fuckyeahcomputerscience:\\\\n\\\\nayiie:\\\\n\\\\nDear Tech Support:Last year I upgraded from Girlfriend 7.0 to Wife 1.0. I soon noticed that the new program began unexpected child processing that took up a lot of space and resources. In addition, Wife 1.0 installed itself into all other programs and now monitors all other system activity. Applications such as Poker Night 10.3, Football 5.0, HuntingAndFishing 7.5, and Racing 3.6. I can\\\\u2019t seem to keep Wife 1.0 in the background while attempting to run my favorite applications. I\\\\u2019m thinking about going back to Girlfriend 7.0, but the uninstall doesn\\\\u2019t work on Wife 1.0. Please help!Thanks \\\\u2026Troubled User\\\\u2014\\\\u2014\\\\u2014-REPLY:Dear Troubled User:This is a very common problem. Many people upgrade from Girlfriend 7.0 to Wife 1.0, thinking that it is just a Utilities and <\\/p>\\n\"]',6),(7,'25th Mar 10','[\"Mobile WebKit browsers don\'t support accessing the scroll position of the document\\/window.\",\"hardcastle: &lt;bugs&gt;GITHub cost me a bank fine. USB Stick won\'t format. My space bar has fallen out.&lt;\\/bugs&gt; --&gt; what next?\",\"hardcastle: Install the magnatune iPhone app For #free #music, like spotify (smaller library)\",\"hardcastle: \\u201cAll programmers are playwrights and all computers are lousy actors.\\u201d - unkown\"]',7),(8,'24th Mar 10','[\"Need to expose the isLocal change globally as well.\",\"Temporarily disable ajax tests when running in TestSwam.\",\"Use custom events for testing unbind instead of the, potentially conflicting, error event.\",\"Adjust isPlainObject test to run in an iframe.\",\"hardcastle: @andygirvan RE jQ-ui 1.8 my fav features are \\\"explode\\\" and backgroundColor animate\"]',8),(9,'23rd Mar 10','[\"Make sure the offset tests work without a built jQuery file.\",\"Update other remote test URLs as well.\",\"Strip off filename and query string for JSONP Remote test.\",\"Update the TestSwarm URL to point to the new jQuery swarm location.\",\"Changed the order of the tests to run in the same order in which they\'re specified in the Makefile (fixed a dimensions test bug that popped up as a result).\",\"Handle auto-running of the TestSwarm injection script in the test suite.\",\"Made it so that you no longer need to build jQuery in order to run the test suite (but you\'ll still need a checkout of QUnit and Sizzle, at least).\"]',9),(10,'21st Mar 10','[\"hardcastle: @jevillustration queens more like... Where\'s the cheezburger at?\",\"<p>This is partial view photo_summary<\\/p>\\n<img src=\\\"http:\\/\\/26.media.tumblr.com\\/tumblr_kznm2uEavc1qzpuawo1_75sq.png\\\" alt=\\\"Templated\\\"\\/>\",\"hardcastle: I\'m having fun with the tumblr iTouch app, but the navigation is a little poor IMHO\"]',10),(11,'20th Mar 10','[\"hardcastle: What kind of a programmer are you? http:\\/\\/bit.ly\\/5sJSZ0\"]',11),(12,'19th Mar 10','[\"hardcastle: Just been handed a new project titled \\\"Project freedom!\\\"\"]',12),(13,'18th Mar 10','[\"hardcastle: @spol wu-ho Every thing I know about .NET is off stackoverflow. I\'m sure that will help :)\",\"hardcastle: Requesting object JSON from LINQ via AJAX, it\'s very fast, fun and so easy! For now.\"]',13),(14,'17th Mar 10','[\"hardcastle: \\\"If you make it idiot proof, they\'ll build a better idiot\\\" - unknown\"]',14),(15,'16th Mar 10','[\"hardcastle: Just sending @andygirvan a GIT bundle as documented here http:\\/\\/bit.ly\\/bN2gWp I love to share code!\",\"hardcastle: Our kid\'s got a blocked nose. He\'s asleep in his cot and sounds like baby Darth Vader. #awww\",\"hardcastle: RT @trs21219: @philsturgeon git clone jessica alba; git checkout -b ass; --&gt; git archive kelly brooke\"]',15),(16,'13th Mar 10','[\"hardcastle: @calypsomustdie as a contestant or galidiator?\"]',16),(17,'11th Mar 10','[\"Switch to using String.prototype.trim from String.trim as it\'s more-widely available.\"]',17),(18,'09th Mar 10','[\"Rewrote the live\\/delegate submit tests to be more generic.\",\"Make sure that special remove and teardown events get called when .die() is used. Additionally made sure that default actions are triggered when namespaced events are used. Fixes #6202 and #6250.\",\"<p>This is partial view photo_summary<\\/p>\\n<img src=\\\"http:\\/\\/27.media.tumblr.com\\/tumblr_kz15zqGEkr1qzpuawo1_75sq.jpg\\\" alt=\\\"Templated\\\"\\/>\",\"Removing the mention of buliding the docs from the README. Thanks to \'phihag\' in the forum for the heads-up.\",\"Landing a faster trim method. Based upon the work by Travis Hardiman and DBJDBJ. More details here: http:\\/\\/forum.jquery.com\\/topic\\/faster-jquery-trim Fixes #2279, #4452, and #4835.\"]',18),(19,'05th Mar 10','[\"No need to use .call() anymore since we switched from .apply() for appendTo, etc. Thanks to Robert in 2c08004f6d4e7f11a875190e132d204a25cb9418 for the heads-up.\",\"I take that back! It was a bug, but the cache had to be triggered and a collection of cached nodes had to be passed in (an odd case to be sure). Fixes #6227.\",\"Attempted to fix #6227, not entirely sure if it\'s a problem as I\'m having a hard time reproducing it. Regardless, the change is harmless and potentially even speeds up appendTo, etc. slightly.\"]',19),(20,'02nd Mar 10','[\"Added in Ben Alman\'s proposed event.namespace property (the property holds the namespaces specified in a call to trigger). Additionally fixes namespaces with .live(). Fixes #6208 and #6209.\",\"Make sure that we don\'t try to remove data from an applet. Re-Fixes #1675.\",\"Add in the new level information to the closest(Array) test.\",\"We no longer support globally-triggered events on plain objects. This is a trade-off to having good garbage collection on the objects.\",\"Moving more properties onto jQuery.ajax, also copy them back to the jQuery object for backwards compatibility.\",\"Remove the need for the return in sizzle-jquery and just remove the attempt to expose Sizzle completely. jQuery is 100% passing JSLint (\'make lint\') now.\",\"Added in integrated JSLint checking against the jQuery source. Just run \'make lint\' to see the result.\",\"More changes to get jQuery in line with JSLint.\",\"We don\'t want to increment the Ajax counter if there isn\'t a global event.\"]',20),(21,'01st Mar 10','[\"Land some additional tweaks related to running through JSLint.\"]',21),(22,'19th Oct 08','[\"<p>This is partial view photo_summary<\\/p>\\n<img src=\\\"http:\\/\\/30.media.tumblr.com\\/oFlImAcRLf9oyod5XgRCAkP9o1_75sq.jpg\\\" alt=\\\"Templated\\\"\\/>\"]',22),(23,'12th Oct 08','[\"<h3><\\/h3>\\n<p>Why I am being bitten my mosquitoes in the middle of rocktober?<\\/p>\\n\"]',23),(24,'30th Sep 08','[\"<a href=\\\"\\\">Yes you can haz music<\\/a>\\n\",null]',24),(25,'31st Aug 08','[\"<h3>To www or not to www?<\\/h3>\\n<p>\\\\n&#8220;Requiring employees to type &#8216;WWW&#8217; cost companies over $25 billion last year,&#8221; said ICANN representative Emil Scharnsdorf. &#8220;The average Internet surfer takes two seconds to type &#8216;www&#8217; and visits 125 sites a day, add in typos like &#8220;qqq&#8221; and &#8220;ww,&#8221; then wave your hands over your head three times and you&#8217;re at $25 billion.&#8221;\\\\n&#8220;We&#8217;re only concerned with the Internet, but it takes Mandy Patinkin three seconds to say &#8216;www&#8217; and during the Super Bowl that gets expensive.&#8221;\\\\nsource\\\\n\\\\n\\\\n<\\/p>\\n\"]',25),(26,'29th Aug 08','[\"<h3>I went to a party tonight and ...<\\/h3>\\n<p>I mentioned something I quite often use during a conversation about the internet. The Romans built roads, the Victorians built railways and we. Today build the information super highway [yuk - (i mean the web)] - just thought I would share that.<\\/p>\\n\"]',26),(27,'28th Aug 08','[\"<p>This is partial view photo_summary<\\/p>\\n<img src=\\\"http:\\/\\/24.media.tumblr.com\\/oFlImAcRLd6usj9iFb5AmxjX_75sq.jpg\\\" alt=\\\"Templated\\\"\\/>\",\"<p>This is partial view photo_summary<\\/p>\\n<img src=\\\"http:\\/\\/27.media.tumblr.com\\/oFlImAcRLd6ujr313aLnfQPL_75sq.jpg\\\" alt=\\\"Templated\\\"\\/>\"]',27),(28,'27th Aug 08','[\"<p>This is partial view photo_summary<\\/p>\\n<img src=\\\"http:\\/\\/27.media.tumblr.com\\/oFlImAcRLd5pq9hxjb2GYcQT_75sq.jpg\\\" alt=\\\"Templated\\\"\\/>\"]',28),(29,'26th Aug 08','[\"<h3><\\/h3>\\n<p>Fantastic word for climate change in German &#8220;klimakatastrophe&#8221;<\\/p>\\n\",\"<a href=\\\"\\\">Your no one if your not on Twitter<\\/a>\\n\"]',29),(30,'22nd Aug 08','[\"<p>This is partial view photo_summary<\\/p>\\n<img src=\\\"http:\\/\\/24.media.tumblr.com\\/oFlImAcRLcym2jdpvZeOre9N_75sq.jpg\\\" alt=\\\"Templated\\\"\\/>\"]',30),(31,'18th Aug 08','[\"<p>This is partial view photo_summary<\\/p>\\n<img src=\\\"http:\\/\\/26.media.tumblr.com\\/oFlImAcRLct5l23yBx8Gz0RS_75sq.jpg\\\" alt=\\\"Templated\\\"\\/>\"]',31),(32,'17th Aug 08','[\"<h3>In Scotland<\\/h3>\\n<p>Our holiday has got off to a great start. We pulled out of Euston on the sleeper train and checked into the overnight cabin. It was like a padding prison cell with a whole array of free-bees. In the morning we awoke to highland views of Scotland and we ate free breakfast as we wattched it all speeding past the windows. Awsome views.\\\\nMy friends were not kidding we can see Ben Nevis from anywhere we stand. Its going to be more difficult to climb than I thought. We will be getting the cable car for sure, More later.<\\/p>\\n\"]',32),(33,'15th Aug 08','[\"<p>This is partial view photo_summary<\\/p>\\n<img src=\\\"http:\\/\\/28.media.tumblr.com\\/oFlImAcRLco9vyv8zLbpdUaZ_75sq.jpg\\\" alt=\\\"Templated\\\"\\/>\"]',33);
/*!40000 ALTER TABLE `kh_timeline` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2010-04-03 23:00:02
